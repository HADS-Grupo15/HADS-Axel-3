...
Public Class ImportarXML
    ...
    Protected Sub DropDownList1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles DropDownList1.SelectedIndexChanged
        ...
        If found Then
            ...
            xmlControl.DocumentSource = Server.MapPath("../App_Data/" & DropDownList1.SelectedValue & ".xml")

            xmlControl.TransformSource = Server.MapPath("../App_Data/XSLTFile.xsl")
    ...
    Protected Sub btnSortCod_Click(sender As Object, e As EventArgs) Handles btnSortCod.Click
        ...
        xmlControl.TransformSource = Server.MapPath("../App_Data/XSLTCodigo.xslt")
    ...
    Protected Sub btnSortDesc_Click(sender As Object, e As EventArgs) Handles btnSortDesc.Click
        ...
        xmlControl.TransformSource = Server.MapPath("../App_Data/XSLTDescripcion.xslt")
    ...
    Protected Sub btnSortHE_Click(sender As Object, e As EventArgs) Handles btnSortHE.Click
        ...
        xmlControl.TransformSource = Server.MapPath("../App_Data/XSLTHEstimadas.xslt")
